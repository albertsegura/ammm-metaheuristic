...
SampleDecoder::SampleDecoder(int Inst_num, int Proc_num, int *I_matrix, int *Df, int *Ex, int *Wb, int Maxiter) {
...
//function h in paper
int find_best_k(int inst_id, int tdf, int tex, int twb, 
